...
module alu_11 (
  ...
  always @* begin
    ...
    M_cmp_v = M_adder_v;
    M_cmp_n = M_adder_n;
    M_cmp_alufncmper = fn[1+1-:2];
    M_bool_a = a;
    M_bool_b = b;
    M_bool_alufnbooler = fn[0+3-:4];
    M_shifter_a = a;
    M_shifter_b = b;
    M_shifter_alufnshifter = fn[0+1-:2];
